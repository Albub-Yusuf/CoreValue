                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo"><a href="#">Core Value.</a></div>
                            <nav class="main_nav">
                                <ul>
                    ...
                    <div class="col">
                        ...
                        <div class="product_grid">
                            ...
                            @foreach($products as $product)
                                <div class="product">
                                    <div class="product_image"><img  width="50%" src="{{asset($product->product_image[0]->file_path)}}" alt=""></div>
                                    <!--div class="product_extra product_new"><a href="#">New</a></div-->
                                    <div class="product_content">
                                        <div class="product_title"><a href="product.html">{{$product->name}}</a></div>
                                        <div class="product_price"><span>&#2547;</span>&nbsp{{$product->price}}</div>
                                    </div>
                                </div>
                            @endforeach
