...
@section('content')
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home2')}}"><i class="icon-home"></i></a></li>
                    ...
                    @foreach($featured_products as $product)
                        <div class="product">
                            ...
                            <div class="product-details">
                                <div class="ratings-container">
                                    <div class="">
                                        <span class="" style="width:80%"></span><!-- End .ratings -->
                                    </div><!-- End .product-ratings -->
                                </div><!-- End .product-container -->
                                <h2 class="product-title">
                                ...
                                <div class="price-box">
                                    <span class="{{route('product.details',$product->id)}}">BDT{{$product->price}}</span>
                                </div><!-- End .price-box -->
